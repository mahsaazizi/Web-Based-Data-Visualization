d3.parcoords = function(config) {
  var __ = {
    ...
    width: 940,
    height: 750,
    margin: { top: 34, right: 0, bottom: 10, left: 0 },
    color: "#069",
...
const tooltip = d3.select('#tooltip');
      //drawTooltip
      function drawTooltip(dimension, i) {
        var g = pc.svg.selectAll(".label");
       if (i==1){
        return tooltip.html("Indicator of the quality of potential labour supply for businesses")
        .style('display', 'block')
        .style("position", 'absolute')
        .style("left", '160px')
        .style("top", '120px');
      }else if (i==2){
        return tooltip.html("Measures a community's conduciveness to business. Lower taxes means business owners can keep a greater portion of their revenues as profits.")
        .style('display', 'block')
        .style("position", 'absolute')
        .style("left", '160px')
        .style("top", '120px');
      }else if (i==3){
        return tooltip.html("Measure of a potential community's spending ability")
        .style('display', 'block')
        .style("position", 'absolute')
        .style("left", '160px')
        .style("top", '120px');
      }else if (i==4){
        return tooltip.html("Participation rate comprises of people who have jobs and those people who are actively looking for a job. For businesses, it is a measure of the size of labour pool. Consumers use it as an indicator of the variety of services and products available at their disposal.")
        .style('display', 'block')
        .style("position", 'absolute')
        .style("left", '160px')
        .style("top", '120px');
      }else if (i==5){
        return tooltip.html("Measure of how large is the market for a business. It is also an indicator of a community's liveliness for families and newcomers.")
        .style('display', 'block')
        .style("position", 'absolute')
        .style("left", '160px')
        .style("top", '120px');
      }else if (i==6){
        return tooltip.html("Indicates the level of convenience in a community. It measures the ease of getting from one place to another. ")
        .style('display', 'block')
        .style("position", 'absolute')
        .style("left", '160px')
        .style("top", '120px');
      }else if (i==7){
        return tooltip.html("Measure for the cost of living in a community, as housing costs is among largest expense in a household.")
        .style('display', 'block')
        .style("position", 'absolute')
        .style("left", '160px')
        .style("top", '120px');
